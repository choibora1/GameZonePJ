...
public class UserController {
	...
	//-----------------------------------------------------------------------------------------------------
		...
		public ModelAndView download(HttpServletRequest request, ModelAndView mv, @RequestParam("downloadfile") String dnfile) {
			
			String realPath = request.getRealPath("/");
			String fileName = dnfile.substring(dnfile.lastIndexOf("/") + 1);
			
			if (realPath.contains(".eclipse."))
				realPath = "C:\\MTest\\myWork\\GameZone\\src\\main\\webapp\\resources\\user_uploadImg\\" + fileName;
			
			else
				realPath += "resources\\user_uploadImg\\" + fileName;
...
//-----------------------------------------------------------------------------------------------------------------------
		...
		@RequestMapping(value = "/joinUser")
		   public ModelAndView joinUser(HttpServletRequest request, HttpServletResponse response, ModelAndView mv, UserVO vo, 
			...
			if (realPath.contains(".eclipse."))
				realPath = "C:\\MTest\\myWork\\GameZone\\src\\main\\webapp\\resources\\user_uploadImg\\";
