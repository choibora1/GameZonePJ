	...
	<c:if test="${not empty message}">
   	...
   	<main id="Game_main">
				...
				<c:if test="${not empty rank}">
					<c:if test="${not empty loginID}">
						<c:forEach var="rank" items="${rank}">
							<li>
								<a class="rank_list" href="detailPcGame?game_name=${rank.game_name}">${rank.game_name}</a>
							</li>
						</c:forEach>
					</c:if>
					...
					<c:if test="${empty loginID}">
						<c:forEach var="rank" items="${rank}">
							<li>
								<span class="rank_list pointer" href="detailPcGame?game_name=${rank.game_name}" onclick="detailContent()">${rank.game_name}</span>
							</li>
						</c:forEach>
					</c:if>
				</c:if>
     	...
     	<div id="gameSearchBar">
			<form action="axPcGame" method="get" id="GameForm">
            	<div>
               		<div id="left_title">
            	...
            	<div id="search" class="search_part">
               		...
               		<input type="button" value="검색" id="axPcGame">
