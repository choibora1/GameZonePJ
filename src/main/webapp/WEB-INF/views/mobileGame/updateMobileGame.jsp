...
<head>
	...
	<body>
	   ...
	   <!-- Header section end -->
		...
		<hr>
		<form action="updateMobileGame" method="post" enctype="multipart/form-data">
			<table>
				<tr height="40">
				...
				<tr height="40">
					...
					<td><input type="text" name="category" value="${one.category}" size="40"></td>
				</tr>
				...
				<tr height="40">
					...
					<td><input type="text" name="video" value="${one.video}" size="40"></td>
				</tr>
