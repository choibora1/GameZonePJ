               ...
               <div class="recent-game-item">
                  ...
                  <div class="rgi-content">
                     <c:if test="${not empty loginID}">
                        ...
                        <a href="https://rox.gnjoy.com/pre-register" class="comment" target="_blank">공식사이트</a>
                     </c:if>
               ...
               <div class="recent-game-item">
                  ...
                  <div class="rgi-content">
                     <c:if test="${not empty loginID}">
                        ...
                        <a href="https://www.facebook.com/%ED%83%95%ED%83%95%ED%8A%B9%EA%B3%B5%EB%8C%80-104971712253133" class="comment" target="_blank">공식사이트</a>
                     </c:if>
               ...
               <div class="recent-game-item">
                  ...
                  <div class="rgi-content">
                     <c:if test="${not empty loginID}">
                        ...
                        <a href="https://baramy.nexon.com/?channel=3801" class="comment" target="_blank">공식사이트</a>
                     </c:if>
